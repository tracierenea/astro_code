function [r_rel_x, v_rel_x, a_rel_x] = rva_relative(rA,vA,rB,vB,mu)
...
% QXx - DCM of the LVLH frame relative to the geocentric equatorial frame (GEF)
...
% -----------------------------------------------------------
%
% Tracie Perez, 12/10/2016 - edits made to this functions as noted
% This function is given in Appendix D.31 in Curtis' Orbtial Mechanics for
% Engineering Students, 3rd Edition.
...
% QXx = [i; j; k]; % curtis had this, but this produces a 9x1
QXx = [i'; j'; k']; % TRP, 12/10/2016, Equation 7.11, produces 3x3
...
r_rel_x = QXx*r_rel;  % TRP, 12/10/2016, removed transpose on r_rel
v_rel_x = QXx*v_rel;  % TRP, 12/10/2016, removed transpose on v_rel
a_rel_x = QXx*a_rel;  % TRP, 12/10/2016, removed transpose on a_rel
end %rva_relative
