function [] = print_sim_description(m, y_meas, error_vec, dt,           ...
              noise_std_Doppler, noise_std_range, guess_error, X0_mom,  ...
              X0_fem, x0_guess)
...
fprintf('Measurements created             : %i \n', size(y_meas,1));
...
fprintf('Std of Doppler measurement noise : %.3f Hz\n', noise_std_Doppler);
fprintf('Std of range measurement noise   : %.3f km\n', noise_std_range);
